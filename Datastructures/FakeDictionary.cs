...
namespace Vintagestory.API.Datastructures
{
    ...
    public class FakeDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        TKey[] keys;
        TValue[] values;
        private int count;
        ...
        public FakeDictionary(int size)
        {
            keys = new TKey[size];
            values = new TValue[size];
        }

        public FakeDictionary(TKey key, TValue value) : this(1)
        {
            keys[0] = key;
            values[0] = value;
        }
        ...
        public FakeDictionary<TKey, TValue> Clone()
        {
            var result = new FakeDictionary<TKey, TValue>(count);
