...
namespace Vintagestory.API.MathTools
{
    ...
    /// </summary>
    public class NormalizedPerlinNoise
    {
        ...
        public NormalizedPerlinNoise(double[] inputAmplitudes, double[] frequencies, long seed)
        {
        ...
        /// <returns></returns>
        public static NormalizedPerlinNoise FromDefaultOctaves(int quantityOctaves, double baseFrequency, double persistence, long seed)
        {            
            ...
            return new NormalizedPerlinNoise(amplitudes, frequencies, seed);
        }
